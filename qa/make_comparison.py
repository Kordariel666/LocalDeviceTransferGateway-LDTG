...
ROOT = Path(r"<USER_PROFILE>\Documents\Projekte\DesktopMobileDataCenter-DMDC")
REFERENCE = Path(
    r"<USER_PROFILE>\.codex\generated_images\01a04f2c-5e85-7520-a57c-457ca534c70c\exec-3c0689bd-bcf5-4a06-92af-32f3e3aff042.png"
)
ITEMS = [
