...
| `cargo fmt --all -- --check` | bestanden | Exitcode 0. Die Runner-Warnung, `C:\Users\marcb` nicht kanonisieren zu können, stammt aus der Sandbox und zeigt keinen Formatfehler. |
