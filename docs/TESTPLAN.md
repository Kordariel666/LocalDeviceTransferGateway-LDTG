...
P2-Regressionen prüfen zusätzlich, dass persistiertes Netzwerkvertrauen nur bei
identischer stabiler ID und identischer bekannter Kategorie gilt, dass mehrere
IP-Aliase desselben auflösbaren physischen Peers gemeinsam höchstens den lokalen
Zehner-Auth-Haushalt verbrauchen und dass der Uninstall-Hook aktuelle und
historische Firewallregel strikt entfernt, nachprüft und bei Fehler abbricht.
Die aggregierten Diagnosefelder werden mit sensitiven Sentinelwerten auf das
Fehlen von Pfaden, IPs und Netzwerk-/Programmkennungen geprüft.
...
- Installation und Deinstallation auf Windows 11 25H2, jeweils mit angenommener und abgebrochener UAC-Abfrage. Windows 10 und ältere Windows-11-Stände gelten höchstens als nicht unterstützte Kompatibilitätsbeobachtung.
- Nach der Deinstallation prüfen, dass Konfiguration, Logs und Sentinel-Nutzdaten unter beiden LDTG-AppData-Bäumen erhalten bleiben, während aktuelle und historische Firewallregel entfernt sind; bei UAC-Abbruch oder absichtlich provoziertem PowerShellfehler darf der Uninstaller keinen Erfolg melden.
